...
export function CandidateCard({
  ...
  const isPreset = candidate.scoring_status === 'skipped' || candidate.preview_status === 'source_audio';
  ...
  return (
    ...
    >
      ...
      <div className="p-5">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mt-0.5">
              {isPreset ? (
                <span className="text-[10px] font-semibold text-cyan-300 uppercase tracking-wider">Preset</span>
              ) : (
                <>
        ...
        {isPreset ? (
          <div className="mb-3 rounded-lg border border-cyan-500/15 bg-cyan-500/5 px-3 py-2 text-[10px] text-cyan-200">
            Uses the uploaded source audio until you reprocess this preset.
          </div>
        ) : (
